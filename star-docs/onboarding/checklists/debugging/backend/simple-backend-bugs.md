...
داده‌هایی که باید مورد توجه قرار بگیرد.
...
+ توجه به حالت‌های خاص و کانفیگ‌هایی که ممکن است روی این مورد اثر بگذارد.
...
### رفع باگ
با توجه به منطقی که از رفتار در سامانه انتظار داریم و کدهایی که وجود دارد دقیقا تغییر مورد نظر را ایجاد می‌کنیم.
در این تغییر باید به موضوع رفتار درست و حالت‌های خاص هم توجه کنیم. و چیزی خراب نشود.