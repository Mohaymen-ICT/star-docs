...
:::tip
به صورت کلی همه‌ی خطاهایی که به صورت انگلیسی به کاربر نشان داده می‌شوند باگ است و در صورتی که باید یک خطا به کاربر نمایش داده شود و پرتاب این خطا به معنای باگ نیست لازم است حتما به زبان‌فارسی ترجمه شده باشد.
:::
